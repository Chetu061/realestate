            ...
            @if ($status === 'active')
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="state">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('all_state') }}" class="nav-link">All State</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('add/state') }}" class="nav-link">Add State</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="amenitie">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('all_amenitie') }}" class="nav-link">All Amenitie</a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('add_amenitie') }}" class="nav-link">Add Amenitie</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="property">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('all_property') }}" class="nav-link">All Property</a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('add_property') }}" class="nav-link">Add Property</a>
                            </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.package.history') }}" class="nav-link">
                        <i class="link-icon" data-feather="calendar"></i> <span class="link-title">Package
                            History</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="testimonials">
                        <ul class="nav sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/add/testimonials') }}" class="nav-link">Add Testimonials</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="Post">
                        <ul class="nav sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('add_post') }} " class="nav-link">Add Post </a>
                            </li>
