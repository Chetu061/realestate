                ...
                <div class="property-details-content">
                    ...
                    <div class="location-box content-widget">
                        ...
                        <ul class="info clearfix">
                            <li><span>Address:</span> {{ $property->property_code }}</li>
                                    ...
                                    @foreach ($facility as $fas)
                                        <div class="box clearfix">
                                            <div class="text pull-left">
                                                <h6>{{ $fas->facility_name }}<span> ({{ $fas->distance }})km</span>
                                                </h6>
                                            </div>
                    ...
                    <div class="statistics-box content-widget">
                        ...
                        <figure class="image-box">
                            <iframe width="700" height="415"
                                src="https://www.youtube.com/embed/4jnzf1yj48M?si=IyB-sA7cJgOWJ7rj"
