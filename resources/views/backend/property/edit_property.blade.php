...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update_property', $property->id) }}" id="myForm1"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="bedrooms"
                                                class="form-control"value="{{ $property->bedrooms }}">
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="garage"
                                                class="form-control"value="{{ $property->garage }}">
                                        </div>
                                    </div><!-- Col` -->
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label">Garage_size</label>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="address"
                                                class="form-control"value="{{ $property->address }}">
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="city"
                                                class="form-control"value="{{ $property->city }}">
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="state"
                                                class="form-control"value="{{ $property->state }}">
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="postal_code"
                                                class="form-control"value="{{ $property->postal_code }}">
                                        </div>
                                    </div><!-- Col -->
                                </div><!-- Row -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="property_size"
                                                class="form-control"value="{{ $property->property_size }}">
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="property_video"
                                                class="form-control"value="{{ $property->property_video }}">
                                        </div>
                                    </div><!-- Col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="neighbourhood"
                                                class="form-control"value="{{ $property->neighbourhood }}">
                                        </div>
                                    </div><!-- Col -->
                                </div><!-- Row -->
    ...
    <div class="page-content" style="margin-top: -34px">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update_property_thumbnail') }}" id="myForm1"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $property->id }}">
    ...
    <!----For Section[ add more button work] -------->
